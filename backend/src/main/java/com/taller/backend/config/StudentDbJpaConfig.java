...
@EnableJpaRepositories(
        basePackages = "com.taller.backend.bd2.repository",
...
public class StudentDbJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean studentEntityManagerFactory(
        ...
        factoryBean.setJtaDataSource(studentDataSource);
        factoryBean.setPackagesToScan("com.taller.backend.bd2.entity");
